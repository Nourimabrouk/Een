...
class AudioScanner {
    constructor() {
        ...
        this.tracks = [];
        this.preferredFormats = ['.mp3', '.webm', '.mp4', '.ogg', '.wav', '.m4a']; // Priority order
    }
    ...
    async fetchAudioFileList() {
        ...
        // we'll try to access known files from our download script
        const knownFiles = [
            'U2 - One.mp4',
            'U2 - One.webm', 
            'Bon Jovi - Always.mp4',
    ...
    getFallbackTracks() {
        // Fallback tracks if scanning fails
        return [
            {
                id: 'unity-thefatrat',
                name: 'Unity',
