...
'''
        ...
        print("3. Deploy: aws lambda create-function --cli-input-json lambda_function.json")
...
'''
        ...
        print("3. Deploy: gcloud functions deploy een-framework --runtime python311 --trigger-http")
...
'''
        ...
        print("3. Deploy: az functionapp create --name een-framework --consumption-plan-location eastus")
...
'''
        ...
        app_json = {
            ...
            "repository": "https://github.com/yourusername/een",
...
def main():
    parser = argparse.ArgumentParser(description="Deploy Een Framework to cloud platforms")
    parser.add_argument("--platform", choices=["aws", "gcp", "azure", "heroku", "railway", "render", "all"],
